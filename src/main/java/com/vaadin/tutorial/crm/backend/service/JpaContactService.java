...
public class JpaContactService implements ContactService {
    private static final Logger LOGGER = Logger.getLogger(JpaContactService.class.getName());

    private CompanyRepository companyRepository;
    private ContactRepository contactRepository;

    public JpaContactService(CompanyRepository companyRepository, ContactRepository contactRepository) {
